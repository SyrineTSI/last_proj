...
TRAINED_MODEL_PATH = os.path.join(base_dir, 'starter/trained_model.pkl')
encoder_path = os.path.join(base_dir, 'starter/encoder.pkl')
lb_path = os.path.join(base_dir, 'starter/label_binarizer.pkl')
